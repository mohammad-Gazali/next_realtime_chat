...
const FriendRequestsSidebarOption = ({ initialUnseenRequestCount, sessionId }: { initialUnseenRequestCount: number, sessionId: string }) => {
    ...
    return (
        <Link href="/dashboard/requests" className="text-gray-700 hover:text-indigo-600 hover:bg-gray-50 group flex items-center gap-3 rounded-md py-2 text-sm leading-6 font-semibold">
